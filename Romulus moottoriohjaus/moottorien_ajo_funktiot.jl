...
#println(moottori_profile[10], " ",moottori_profile[3], " ",round(nykyinen_asema,2), " ",moottori_profile[4], " ",moottori_profile[5], " ",moottori_profile[6])
  if( abs(moottori_profile[3]-nykyinen_asema) > moottori_profile[15] && moottori_profile[14] == 0.0) #Jos jarrutus matka riittää vielä, niin kiihdytetään tai ajetaan.
    #println("ajoa")
    ...
    moottori_profile[15] = abs(0.5*moottori_profile[6]*(moottori_profile[10]/moottori_profile[6])^2) #Jarrutus matka
  else
    #println("jarrutus")
