...
function plc_mevea_connection()
  ...
  Tao = 0.001 #Moottoin reaktio nopeus Time Constant
  aika_askel = 0.001
  Driker = 0.0
  ...
  moottorit = zeros(10,length(moottorien_ruuvien_nousut))
 ...
 =#
        if(ins_matrix_PLC[3,moottori] == 0 && ins_matrix_PLC[4,moottori] == 0) #Paikkasäätöinen
          ...
          if ((ins_matrix_PLC[1,moottori] == 1 && Driker_muutos == 1.0) || ( abs(ins_matrix_PLC[6,moottori] - moottorit[7,moottori])  - abs(moottorit[7,moottori] - ins_matrix_Mevea[1,moottori])) < 0.0)
            println("alustetaan lähtöä arvoilla: ","Haluttu arvot:",ins_matrix_PLC[6,moottori],"mm ",ins_matrix_PLC[7,moottori],"mm/s ",ins_matrix_PLC[8,moottori],"mm/s2 ",ins_matrix_PLC[9,moottori],"mm/s2. Lähtöarvot:",ins_matrix_Mevea[1,moottori],"mm ",ins_mevea[end]-0.001,"s." )
          ...
          muuttuja = position_control(ins_matrix_Mevea[1,moottori],moottorit[3,moottori],moottorit[7,moottori],moottorit[8,moottori],ins_mevea[end],ins_matrix_Mevea[2,moottori],moottorit[4,moottori],moottorit[5,moottori],moottorit[6,moottori])
          #println("muutetaan ulos tuloa arvoilla: Haluttu nopeus:",millimetri_kierrosnopeudeksi(moottorit[4,moottori],moottorit[1,moottori]), "rad/s ",moottorit[2,moottori],"Nm ",millimetri_kierrosnopeudeksi(muuttuja,moottorit[1,moottori]),"rad/s ",ins_matrix_Mevea[3,moottori],"Nm ",Tao)

          #PID säädin prkl
          muuttuja,moottorit[9,moottori],moottorit[10,moottori] = pid_saadin(muuttuja,ins_matrix_Mevea[2,moottori],moottorit[9,moottori],moottorit[10,moottori],aika_askel)
          ...
          muuttuja = ins_matrix_Mevea[3,moottori] +kierrokset_vaannoksi(millimetri_kierrosnopeudeksi(moottorit[4,moottori],moottorit[1,moottori]),moottorit[2,moottori],millimetri_kierrosnopeudeksi(muuttuja,moottorit[1,moottori]),ins_matrix_Mevea[3,moottori],Tao,0.0)*aika_askel
          outs_mevea[1,moottori] = muuttuja/moottorit[2,moottori]
        end
      end

      println("lähetetään mevealle: ", outs_mevea, "Nm")
